...
void wczytaj (double *a1, double *b1, double *c1, double *a2, double *b2, double *c2){
	...
	puts ("Podaj wyznacznik a1"); scanf("%lf", a1);
	puts ("Podaj wyznacznik b1"); scanf("%lf", b1);
	puts ("Podaj wyznacznik c1"); scanf("%lf", c1);
	puts ("Podaj wyznacznik a2"); scanf("%lf", a2);
	puts ("Podaj wyznacznik b2"); scanf("%lf", b2);
	puts ("Podaj wyznacznik c2"); scanf("%lf", c2);
